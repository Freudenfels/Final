...
class DHLPaketProvider():
    ...
    def _get_acc_no(self, carrier):
        ...
        digit10_account_number = carrier.sudo().dhl_de_paket_account_number
        account_number = "%s%s%s" % (digit10_account_number, procedure_no,
                                     carrier.sudo().dhl_de_paket_partner_no)
    ...
    def _get_shipment_items(self, picking, carrier):
        ...
        if move_lines_with_package:
            ...
            for package in picking.package_ids:
                packaging = package.package_type_id or carrier.dhl_de_paket_default_packaging_id
